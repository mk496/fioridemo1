		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "northwinddest",
									"targetURL": "#northwindnorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"northwindnorthwind-display": {
								"semanticObject": "northwindnorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=northwind.northwind",
									"url": sap.ui.require.toUrl("northwind/northwind")
								}
							}
						}
					}
